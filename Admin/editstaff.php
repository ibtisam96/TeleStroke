...
$sql = "UPDATE Staff SET  staff_id='$idform', first_name='$nameform1',last_name='$nameform2', role='$roleform', sgender='$genderform',sphone_no='$phoneno', hospital_id='$hospitalid',email='$email' WHERE staff_id= '$idform'";
