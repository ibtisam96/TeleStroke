...
--
-- Host: localhost
-- Generation Time: Mar 02, 2018 at 01:10 PM
...
INSERT INTO `Staff` (`staff_id`, `first_name`, `last_name`, `role`, `sgender`, `sphone_no`, `hospital_id`, `email`, `type`) VALUES
...
--
ALTER TABLE `problem_report`
  ADD CONSTRAINT `reportstaff_staff` FOREIGN KEY (`staff_id`) REFERENCES `Staff` (`staff_id`);
...
--
ALTER TABLE `Session`
  ADD CONSTRAINT `participanthub_staff` FOREIGN KEY (`hub_id`) REFERENCES `Staff` (`staff_id`),
  ADD CONSTRAINT `participantpatient_patient` FOREIGN KEY (`patient_id`) REFERENCES `Patient` (`patient_id`),
  ADD CONSTRAINT `participantspoke_staff` FOREIGN KEY (`spoke_id`) REFERENCES `Staff` (`staff_id`);
