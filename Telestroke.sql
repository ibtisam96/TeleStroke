...
--
-- Host: localhost
-- Generation Time: Mar 06, 2018 at 03:59 PM
...
--
ALTER TABLE `Logindetails`
  ADD CONSTRAINT `login_staff` FOREIGN KEY (`staff_id`) REFERENCES `Staff` (`staff_id`);
...
--
ALTER TABLE `Problem_report`
  ADD CONSTRAINT `problem_staff` FOREIGN KEY (`staff_id`) REFERENCES `Staff` (`staff_id`);
...
--
ALTER TABLE `Session`
  ADD CONSTRAINT `session_hubstaff` FOREIGN KEY (`hub_id`) REFERENCES `Staff` (`staff_id`),
  ADD CONSTRAINT `session_patient` FOREIGN KEY (`patient_id`) REFERENCES `Patient` (`patient_id`),
  ADD CONSTRAINT `session_spokestaff` FOREIGN KEY (`spoke_id`) REFERENCES `Staff` (`staff_id`);

--
-- Constraints for table `Staff`
--
ALTER TABLE `Staff`
  ADD CONSTRAINT `staff_hospital` FOREIGN KEY (`hospital_id`) REFERENCES `Hospital` (`hospital_id`);
