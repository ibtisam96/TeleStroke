...
--
-- Host: localhost
-- Generation Time: Feb 26, 2018 at 03:31 PM
...
INSERT INTO `Hospital` (`hospital_id`, `name`, `type`, `phone_no`, `location`) VALUES
...
INSERT INTO `Medical_record` (`MR_id`, `admissiondate`, `chronic_disease`, `brain_imaging`, `pulse`, `bloodpressure`, `weight`, `height`, `patient_id`) VALUES
...
INSERT INTO `Staff` (`staff_id`, `first_name`, `last_name`, `role`, `sgender`, `sphone_no`, `hospital_id`, `email`) VALUES
...
ALTER TABLE `Participation`
  ADD PRIMARY KEY (`staff_id`,`session_id`,`patient_id`),
...
--
ALTER TABLE `Logindetails`
  ADD CONSTRAINT `account_sID` FOREIGN KEY (`staff_id`) REFERENCES `Staff` (`staff_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `Participation`
  ADD CONSTRAINT `participation_patient` FOREIGN KEY (`patient_id`) REFERENCES `Patient` (`patient_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `participation_session` FOREIGN KEY (`session_id`) REFERENCES `Session` (`session_id`),
  ADD CONSTRAINT `participation_staff` FOREIGN KEY (`staff_id`) REFERENCES `Staff` (`staff_id`);
...
--
ALTER TABLE `Staff`
  ADD CONSTRAINT `staff_hospital` FOREIGN KEY (`hospital_id`) REFERENCES `Hospital` (`hospital_id`) ON DELETE CASCADE ON UPDATE CASCADE;
